...
\DoxyCodeLine{\}}
\end{DoxyCode}
 {\ttfamily \char`\"{}\+I\+O\char`\"{}} is either {\ttfamily \char`\"{}read\char`\"{}} or {\ttfamily \char`\"{}write\char`\"{}} for reading from or writing to a file, respectively. {\ttfamily \char`\"{}\+Type\char`\"{}} specifies the field, which can be either {\ttfamily \char`\"{}omega\char`\"{}} for conjugate field or {\ttfamily \char`\"{}phi\char`\"{}} for volume-\/fraction field. {\ttfamily \char`\"{}\+Format\char`\"{}} specifies the format of the field, which can be either {\ttfamily \char`\"{}basis\char`\"{}} for the basis format, {\ttfamily \char`\"{}real\char`\"{}} for the real-\/space-\/grid format, or {\ttfamily \char`\"{}reciprocal\char`\"{}} for the reciprocal-\/space-\/grid format; see this \href{https://dmorse.github.io/pscfpp-man/user_field_page.html}{\texttt{ P\+S\+CF documentation}} for the explaination of these formats. {\ttfamily \char`\"{}\+Directory\char`\"{}} specifies the directory of the file. Finally, the file name is specified by the case ID, field type and format as {\ttfamily your\+\_\+case\+\_\+id\+\_\+type.\+format}; for example, to read a conjugate field in the basis format as input of your S\+CF calculation with the case ID 1234, the file name must be {\ttfamily 1234\+\_\+omega.\+basis}.
